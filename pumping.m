...
if NumStrokes > 2
    message = sprintf('Num Strokes = %0.d, ExtractAngle = %0.2f degrees, Volume Pumped = %0.2f L, Started Pumping at %0.2f for %0.2f sec',NumStrokes,upStrokeExtract, volumeEvent, pumpStartTime,pumpSeconds);
    disp(message);
end
end